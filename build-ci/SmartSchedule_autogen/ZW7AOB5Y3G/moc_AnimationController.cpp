...
#include <memory>
#include "../../../src/services/companion/AnimationController.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AnimationController_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AnimationController_t qt_meta_stringdata_AnimationController = {
    {
        QT_MOC_LITERAL(0, 19),  // "AnimationController"
        QT_MOC_LITERAL(20, 12),  // "frameUpdated"
        QT_MOC_LITERAL(33, 0),  // ""
        QT_MOC_LITERAL(34, 11)   // "updateFrame"
    },
    "AnimationController",
    "frameUpdated",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_AnimationController[] = {
...
Q_CONSTINIT const QMetaObject AnimationController::staticMetaObject = { {
    ...
    qt_meta_stringdata_AnimationController.offsetsAndSizes,
    qt_meta_data_AnimationController,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_AnimationController_t,
        // Q_OBJECT / Q_GADGET
...
void AnimationController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AnimationController::*)();
            if (_t _q_method = &AnimationController::frameUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AnimationController::frameUpdated()
{
